...
$$
\large MVL_{\text{Özkurt}} = \frac{1}{\sqrt{N}} \left|\frac{\frac{1}{N} \sum_{n=1}^{N} a_{u} e^{i\phi_{l}}}{\quad \frac{1}{N} \sum_{n=1}^{N} a_{u}^2}\right| 
$$
...
$$
\large a_{u} = \small \text{the amplitude of the upper frequency band at data point t}
$$
